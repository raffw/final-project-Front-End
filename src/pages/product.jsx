            ...
            <section>
              <div className=" border-b-2 border-midGreen">
                <div className="xl:flex flex-wrap border rounded-md text-center px-2 py-1 md:w-48 mb-4 mx-7 my-4 justify-between ">
                  ...
                  <div className="mr-2 mt-1 inline-block align-middle">
                    <svg
                      className="unf-icon"
                      viewBox="0 0 24 24"
                      width="22"
                  ...
                  <div className="flex mx-2 ">
                    <div>
                      <div className="flex mt-1 font-serif">
                        <div>
                          <div>
                            <p className="text-bold px-1 text-darkGreen rounded-md mr-2 mt-3">
                              Disc:
                            </p>
                          </div>
                          <div>
                            <p className="text-bold text-lg px-1 text-darkGreen rounded-md mr-2 mt">
                              Subtotal:
                            </p>
                          </div>
                        </div>
                        <div className="mt-3">
                          <div>
                            <p className="text-gray-400 text line-through">
                              Rp.99999
                            </p>
                          </div>
                          <div>
                      ...
                      <div className="flex">
                        ...
                        <div className="flex bg-white border border-darkGreen rounded-lg h-10 mt-2">
                          <button
                            ...
                            className="align-middle inline-block mx-1 mb-1"
                            disabled=""
                            tabindex="-1"
                          >
                            <svg
                              className="unf-icon mt-1"
                              viewBox="0 0 24 24"
                              width="16px"
                              height="16px"
                          ...
                          <button
                            aria-label="Tambah 1"
                            className="mx-1 mb-2 align-middle inline-block"
                            tabindex="-1"
                          >
                            <svg
                              className="unf-icon mt-1"
              ...
              <div className="flex border rounded-lg bg-midGreen py-3 mx-4 my-4 justify-center">
                <svg
                  className="unf-icon inline-block mr-2 align-middle"
                  viewBox="0 0 24 24"
                  width="24"
                  height="24"
                  fill="#FFFFFF"
