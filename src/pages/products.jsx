    ...
    return (
        ...
        <Navbar />
            <div className="flex justify-end h-16 bg-green-300 text-white items-center px-10">
                { email }
                <Button classname="ml-5 bg-midGreen" 
            ...
            <div className="flex justify-center py-5">
                ...
                <div className="w-2/6 ">
                    <div className="rounded-md shadow-md">
                        <h1 className="text-2xl font-bold text-green-800 ml-5 mb-2">Cart</h1>
                        {/* <ul>
                        {cart.map((item) => (
...
{/* <CardProduct>
    <CardProduct.Header image= "/img/no-image.png" />
    <CardProduct.Body title="Makanan burger">
        lerem ipsum dolor sit amet. lorem ipssum magna aliquet. lerem ipsum dolor sit amet. lorem ipssum magna aliquet. 
    </CardProduct.Body>
    <CardProduct.Footer price= "Rp. 34.999" />
</CardProduct>

<CardProduct>
    <CardProduct.Header image= "/img/no-image.png" />
    <CardProduct.Body title="Makanan burger">
        lerem ipsum dolor sit amet. lorem ipssum magna aliquet.
    </CardProduct.Body>
    <CardProduct.Footer price= "Rp. 34.999" />
</CardProduct> */}
            <section>
